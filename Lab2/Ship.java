...
public class Ship extends Observable{
	...
	public void move(String s){
		if(s.equals("EAST")){
			if(currentLocation.x<26 && oceanMap.getMap()[currentLocation.x+1][currentLocation.y]!=1)
				currentLocation.x++;
		}
			...
			if(currentLocation.y<26 && oceanMap.getMap()[currentLocation.x][currentLocation.y+1]!=1)
				currentLocation.y++;
		}
